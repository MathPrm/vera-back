...
Et explique ton raisonnement avec les preuves de tes outils.`;
    ...
    parseVeraResponse(veraData, videoData) {
        ...
        // LOG pour debug
        console.log('📥 Réponse Vera brute:', analysisText.substring(0, 500) + '...');
        ...
        // Défaut pour contenu narratif (contes, fables)
            ...
            // Si aucun mot-clé n'est détecté, utiliser la réponse de Vera directement
            summary = analysisText.substring(0, 500); // Prendre les 500 premiers caractères
            score = 70; // Score neutre
            verdict = 'MIXED';
            console.log('⚠️  Aucun mot-clé détecté, utilisation de la réponse brute');
        }

...
async function loadServices() {
  ...
  try {
    ...
    TikTokService = require(path.join(process.cwd(), 'app/services/tiktok.service.js'));
    InstagramService = require(path.join(process.cwd(), 'app/services/instagram.service.js'));
    YouTubeService = require(path.join(process.cwd(), 'app/services/youtube.service.js'));
    VeraService = require(path.join(process.cwd(), 'app/services/vera.service.js'));
...
export const verifyFromUrl = async (req: Request, res: Response): Promise<Response> => {
  try {
    const { url } = req.body;
...
function detectPlatform(url: string): 'tiktok' | 'instagram' | 'youtube' | 'telegram' {
